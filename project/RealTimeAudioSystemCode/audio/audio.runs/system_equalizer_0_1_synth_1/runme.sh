...
HD_PWD='C:/Users/marti/Documents/RealTimeAudioSystemCode/audio/audio.runs/system_equalizer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_equalizer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_equalizer_0_1.tcl
