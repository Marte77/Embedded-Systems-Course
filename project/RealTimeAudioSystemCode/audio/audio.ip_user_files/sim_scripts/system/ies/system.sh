...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../audio.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/2ad9/hdl" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/39ca/hdl/verilog" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/6eb1/hdl" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/1d61/hdl"
}
