; ModuleID = 'C:/Users/marti/Documents/GitHub/Embedded-Systems-Course/project/equalizer/equalizer/.autopilot/db/a.o.3.bc'
...
@iir_coeff_array = internal global [30 x float] zeroinitializer ; [#uses=7 type=[30 x float]*]
...
.preheader4:                                      ; preds = %0, %.preheader4.preheader
  ...
  %tmp_3 = sub i6 %tmp, %p_shl1_cast, !dbg !98    ; [#uses=6 type=i6] [debug line = 36:4@6:9]
  ...
  %tmp_6 = add i6 %tmp_3, 3, !dbg !102            ; [#uses=1 type=i6] [debug line = 39:4@6:9]
  ...
  %tmp_7 = add i6 %tmp_3, 4, !dbg !103            ; [#uses=1 type=i6] [debug line = 40:4@6:9]
  ...
  %tmp_8 = add i6 %tmp_3, 5, !dbg !104            ; [#uses=1 type=i6] [debug line = 41:4@6:9]
  %tmp_8_cast = sext i6 %tmp_8 to i32, !dbg !104  ; [#uses=1 type=i32] [debug line = 41:4@6:9]
  %iir_coeff_array_addr_5 = getelementptr [30 x float]* @iir_coeff_array, i32 0, i32 %tmp_8_cast, !dbg !104 ; [#uses=1 type=float*] [debug line = 41:4@6:9]
  ...
  %i = add i3 %i_i, 1, !dbg !105                  ; [#uses=1 type=i3] [debug line = 34:40@6:9]
  br i1 %exitcond_i, label %filter.exit, label %0, !dbg !74 ; [debug line = 34:26@6:9]

; <label>:0                                       ; preds = %.preheader4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @p_str4) nounwind, !dbg !106 ; [debug line = 34:45@6:9]
  %b0 = load float* %iir_coeff_array_addr, align 8, !dbg !98 ; [#uses=1 type=float] [debug line = 36:4@6:9]
  call void @llvm.dbg.value(metadata !{float %b0}, i64 0, metadata !107) nounwind, !dbg !98 ; [debug line = 36:4@6:9] [debug variable = b0]
  %b1 = load float* %iir_coeff_array_addr_1, align 4, !dbg !100 ; [#uses=1 type=float] [debug line = 37:4@6:9]
  call void @llvm.dbg.value(metadata !{float %b1}, i64 0, metadata !108) nounwind, !dbg !100 ; [debug line = 37:4@6:9] [debug variable = b1]
  %b2 = load float* %iir_coeff_array_addr_2, align 8, !dbg !101 ; [#uses=1 type=float] [debug line = 38:4@6:9]
  call void @llvm.dbg.value(metadata !{float %b2}, i64 0, metadata !109) nounwind, !dbg !101 ; [debug line = 38:4@6:9] [debug variable = b2]
  %a0 = load float* %iir_coeff_array_addr_3, align 4, !dbg !102 ; [#uses=5 type=float] [debug line = 39:4@6:9]
  call void @llvm.dbg.value(metadata !{float %a0}, i64 0, metadata !110) nounwind, !dbg !102 ; [debug line = 39:4@6:9] [debug variable = a0]
  %a1 = load float* %iir_coeff_array_addr_4, align 8, !dbg !103 ; [#uses=1 type=float] [debug line = 40:4@6:9]
  call void @llvm.dbg.value(metadata !{float %a1}, i64 0, metadata !111) nounwind, !dbg !103 ; [debug line = 40:4@6:9] [debug variable = a1]
  %a2 = load float* %iir_coeff_array_addr_5, align 4, !dbg !104 ; [#uses=1 type=float] [debug line = 41:4@6:9]
  call void @llvm.dbg.value(metadata !{float %a2}, i64 0, metadata !112) nounwind, !dbg !104 ; [debug line = 41:4@6:9] [debug variable = a2]
  %iir_x_1_addr = getelementptr [5 x float]* @iir_x_1, i32 0, i32 %i_i_cast3, !dbg !113 ; [#uses=2 type=float*] [debug line = 43:4@6:9]
  %iir_x_1_load = load float* %iir_x_1_addr, align 4, !dbg !113 ; [#uses=1 type=float] [debug line = 43:4@6:9]
  %iir_x_0_addr = getelementptr [5 x float]* @iir_x_0, i32 0, i32 %i_i_cast3, !dbg !114 ; [#uses=2 type=float*] [debug line = 44:4@6:9]
  %iir_x_0_load = load float* %iir_x_0_addr, align 4, !dbg !114 ; [#uses=2 type=float] [debug line = 44:4@6:9]
  store float %iir_x_0_load, float* %iir_x_1_addr, align 4, !dbg !114 ; [debug line = 44:4@6:9]
  store float %temp_i, float* %iir_x_0_addr, align 4, !dbg !115 ; [debug line = 45:4@6:9]
  %tmp_i = fmul float %b0, %temp_i, !dbg !116     ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_3_i = fdiv float %tmp_i, %a0, !dbg !116    ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_4_i = fmul float %b1, %iir_x_0_load, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_5_i = fdiv float %tmp_4_i, %a0, !dbg !116  ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_6_i = fadd float %tmp_3_i, %tmp_5_i, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_7_i = fmul float %b2, %iir_x_1_load, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_8_i = fdiv float %tmp_7_i, %a0, !dbg !116  ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_9_i = fadd float %tmp_6_i, %tmp_8_i, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %iir_y_1_addr = getelementptr [5 x float]* @iir_y_1, i32 0, i32 %i_i_cast3, !dbg !116 ; [#uses=2 type=float*] [debug line = 47:4@6:9]
  %iir_y_1_load = load float* %iir_y_1_addr, align 4, !dbg !116 ; [#uses=2 type=float] [debug line = 47:4@6:9]
  %tmp_i_3 = fmul float %a1, %iir_y_1_load, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_1_i = fdiv float %tmp_i_3, %a0, !dbg !116  ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_2_i = fsub float %tmp_9_i, %tmp_1_i, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %iir_y_2_addr = getelementptr [5 x float]* @iir_y_2, i32 0, i32 %i_i_cast3, !dbg !116 ; [#uses=2 type=float*] [debug line = 47:4@6:9]
  %iir_y_2_load = load float* %iir_y_2_addr, align 4, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_10_i = fmul float %a2, %iir_y_2_load, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %tmp_11_i = fdiv float %tmp_10_i, %a0, !dbg !116 ; [#uses=1 type=float] [debug line = 47:4@6:9]
  %acc = fsub float %tmp_2_i, %tmp_11_i, !dbg !116 ; [#uses=2 type=float] [debug line = 47:4@6:9]
  call void @llvm.dbg.value(metadata !{float %acc}, i64 0, metadata !117) nounwind, !dbg !116 ; [debug line = 47:4@6:9] [debug variable = acc]
  store float %iir_y_1_load, float* %iir_y_2_addr, align 4, !dbg !118 ; [debug line = 51:4@6:9]
  store float %acc, float* %iir_y_1_addr, align 4, !dbg !119 ; [debug line = 52:4@6:9]
  call void @llvm.dbg.value(metadata !{float %acc}, i64 0, metadata !120) nounwind, !dbg !121 ; [debug line = 53:4@6:9] [debug variable = temp]
  call void @llvm.dbg.value(metadata !{i3 %i}, i64 0, metadata !122) nounwind, !dbg !105 ; [debug line = 34:40@6:9] [debug variable = i]
  br label %.preheader4, !dbg !105                ; [debug line = 34:40@6:9]
...
.preheader:                                       ; preds = %.preheader.loopexit, %.preheader.preheader
  ...
  %tmp_9 = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %i_i1, i3 0) ; [#uses=1 type=i6]
  %tmp_s = call i4 @_ssdm_op_BitConcatenate.i4.i3.i1(i3 %i_i1, i1 false) ; [#uses=1 type=i4]
  %p_shl3_cast = zext i4 %tmp_s to i6, !dbg !123  ; [#uses=1 type=i6] [debug line = 27:5@8:4]
  %tmp_10 = sub i6 %tmp_9, %p_shl3_cast, !dbg !123 ; [#uses=1 type=i6] [debug line = 27:5@8:4]
  %exitcond1_i = icmp eq i3 %i_i1, -3, !dbg !132  ; [#uses=1 type=i1] [debug line = 25:14@8:4]
  %empty_4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5, i64 5, i64 5) nounwind ; [#uses=0 type=i32]
  %i_1 = add i3 %i_i1, 1, !dbg !133               ; [#uses=1 type=i3] [debug line = 25:28@8:4]
  call void @llvm.dbg.value(metadata !{i3 %i_1}, i64 0, metadata !134) nounwind, !dbg !133 ; [debug line = 25:28@8:4] [debug variable = i]
  br i1 %exitcond1_i, label %setCoeffs.exit.loopexit, label %.preheader.i.preheader, !dbg !132 ; [debug line = 25:14@8:4]

.preheader.i.preheader:                           ; preds = %.preheader
  br label %.preheader.i, !dbg !123               ; [debug line = 27:5@8:4]

.preheader.i:                                     ; preds = %1, %.preheader.i.preheader
  %j_i = phi i3 [ %j, %1 ], [ 0, %.preheader.i.preheader ] ; [#uses=3 type=i3]
  %j_i_cast1_cast = zext i3 %j_i to i6, !dbg !123 ; [#uses=1 type=i6] [debug line = 27:5@8:4]
  %tmp_11 = add i6 %tmp_10, %j_i_cast1_cast, !dbg !123 ; [#uses=1 type=i6] [debug line = 27:5@8:4]
  %tmp_12_cast = sext i6 %tmp_11 to i32, !dbg !123 ; [#uses=2 type=i32] [debug line = 27:5@8:4]
  %coeffs_addr = getelementptr [30 x float]* %coeffs, i32 0, i32 %tmp_12_cast, !dbg !123 ; [#uses=1 type=float*] [debug line = 27:5@8:4]
  %iir_coeff_array_addr_6 = getelementptr [30 x float]* @iir_coeff_array, i32 0, i32 %tmp_12_cast, !dbg !123 ; [#uses=1 type=float*] [debug line = 27:5@8:4]
  %exitcond_i2 = icmp eq i3 %j_i, -2, !dbg !135   ; [#uses=1 type=i1] [debug line = 26:31@8:4]
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 6, i64 6, i64 6) nounwind ; [#uses=0 type=i32]
  %j = add i3 %j_i, 1, !dbg !136                  ; [#uses=1 type=i3] [debug line = 26:40@8:4]
  br i1 %exitcond_i2, label %.preheader.loopexit, label %1, !dbg !135 ; [debug line = 26:31@8:4]

; <label>:1                                       ; preds = %.preheader.i
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str3) nounwind, !dbg !137 ; [debug line = 26:46@8:4]
  %coeffs_load = load float* %coeffs_addr, align 4, !dbg !123 ; [#uses=1 type=float] [debug line = 27:5@8:4]
  store float %coeffs_load, float* %iir_coeff_array_addr_6, align 4, !dbg !123 ; [debug line = 27:5@8:4]
  call void @llvm.dbg.value(metadata !{i3 %j}, i64 0, metadata !138) nounwind, !dbg !136 ; [debug line = 26:40@8:4] [debug variable = j]
  br label %.preheader.i, !dbg !136               ; [debug line = 26:40@8:4]

setCoeffs.exit.loopexit:                          ; preds = %.preheader
  br label %setCoeffs.exit

setCoeffs.exit:                                   ; preds = %setCoeffs.exit.loopexit, %filter.exit
  ret void, !dbg !139                             ; [debug line = 10:1]
}
...
entry:
  ...
  %empty_6 = zext i3 %1 to i6                     ; [#uses=1 type=i6]
...
entry:
  ...
  %empty_9 = zext i1 %1 to i4                     ; [#uses=1 type=i4]
  %empty_10 = shl i4 %empty, 1                    ; [#uses=1 type=i4]
...
!48 = metadata !{i32 786473, metadata !"equalizer/iir.cpp", metadata !"C:\5CUsers\5Cmarti\5CDocuments\5CGitHub\5CEmbedded-Systems-Course\5Cproject", null} ; [ DW_TAG_file_type ]
...
!78 = metadata !{i32 786473, metadata !"equalizer/iir.h", metadata !"C:\5CUsers\5Cmarti\5CDocuments\5CGitHub\5CEmbedded-Systems-Course\5Cproject", null} ; [ DW_TAG_file_type ]
...
!104 = metadata !{i32 41, i32 4, metadata !99, metadata !97}
!105 = metadata !{i32 34, i32 40, metadata !75, metadata !97}
!106 = metadata !{i32 34, i32 45, metadata !99, metadata !97}
!107 = metadata !{i32 786688, metadata !76, metadata !"b0", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!108 = metadata !{i32 786688, metadata !76, metadata !"b1", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!109 = metadata !{i32 786688, metadata !76, metadata !"b2", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!110 = metadata !{i32 786688, metadata !76, metadata !"a0", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!111 = metadata !{i32 786688, metadata !76, metadata !"a1", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!112 = metadata !{i32 786688, metadata !76, metadata !"a2", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!113 = metadata !{i32 43, i32 4, metadata !99, metadata !97}
!114 = metadata !{i32 44, i32 4, metadata !99, metadata !97}
!115 = metadata !{i32 45, i32 4, metadata !99, metadata !97}
!116 = metadata !{i32 47, i32 4, metadata !99, metadata !97}
!117 = metadata !{i32 786688, metadata !76, metadata !"acc", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!118 = metadata !{i32 51, i32 4, metadata !99, metadata !97}
!119 = metadata !{i32 52, i32 4, metadata !99, metadata !97}
!120 = metadata !{i32 786688, metadata !76, metadata !"temp", metadata !78, i32 32, metadata !52, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!121 = metadata !{i32 53, i32 4, metadata !99, metadata !97}
!122 = metadata !{i32 786688, metadata !75, metadata !"i", metadata !78, i32 34, metadata !54, i32 0, metadata !97} ; [ DW_TAG_auto_variable ]
!123 = metadata !{i32 27, i32 5, metadata !124, metadata !130}
!124 = metadata !{i32 786443, metadata !125, i32 26, i32 45, metadata !78, i32 6} ; [ DW_TAG_lexical_block ]
!125 = metadata !{i32 786443, metadata !126, i32 26, i32 19, metadata !78, i32 5} ; [ DW_TAG_lexical_block ]
!126 = metadata !{i32 786443, metadata !127, i32 25, i32 33, metadata !78, i32 4} ; [ DW_TAG_lexical_block ]
!127 = metadata !{i32 786443, metadata !128, i32 25, i32 3, metadata !78, i32 3} ; [ DW_TAG_lexical_block ]
!128 = metadata !{i32 786443, metadata !129, i32 24, i32 43, metadata !78, i32 2} ; [ DW_TAG_lexical_block ]
!129 = metadata !{i32 786478, i32 0, null, metadata !"setCoeffs", metadata !"setCoeffs", metadata !"_ZN9IIRFilter9setCoeffsEPA6_f", metadata !78, i32 24, metadata !94, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !93, metadata !59, i32 24} ; [ DW_TAG_subprogram ]
!130 = metadata !{i32 8, i32 4, metadata !131, null}
!131 = metadata !{i32 786443, metadata !72, i32 7, i32 8, metadata !48, i32 1} ; [ DW_TAG_lexical_block ]
!132 = metadata !{i32 25, i32 14, metadata !127, metadata !130}
!133 = metadata !{i32 25, i32 28, metadata !127, metadata !130}
!134 = metadata !{i32 786688, metadata !127, metadata !"i", metadata !78, i32 25, metadata !54, i32 0, metadata !130} ; [ DW_TAG_auto_variable ]
!135 = metadata !{i32 26, i32 31, metadata !125, metadata !130}
!136 = metadata !{i32 26, i32 40, metadata !125, metadata !130}
!137 = metadata !{i32 26, i32 46, metadata !124, metadata !130}
!138 = metadata !{i32 786688, metadata !125, metadata !"j", metadata !78, i32 26, metadata !54, i32 0, metadata !130} ; [ DW_TAG_auto_variable ]
!139 = metadata !{i32 10, i32 1, metadata !72, null}
