...
// wrapc file define: "y"
#define AUTOTB_TVOUT_y  "../tv/cdatafile/c.equalizer.autotvout_y.dat"
// wrapc file define: "x"
#define AUTOTB_TVIN_x  "../tv/cdatafile/c.equalizer.autotvin_x.dat"
// wrapc file define: "mode"
#define AUTOTB_TVIN_mode  "../tv/cdatafile/c.equalizer.autotvin_mode.dat"
// wrapc file define: "coeffs"
#define AUTOTB_TVIN_coeffs  "../tv/cdatafile/c.equalizer.autotvin_coeffs.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "y"
#define AUTOTB_TVOUT_PC_y  "../tv/rtldatafile/rtl.equalizer.autotvout_y.dat"
...
extern void equalizer (
float* y,
float x,
int mode,
float coeffs[5][6]);

void AESL_WRAP_equalizer (
float* y,
float x,
int mode,
float coeffs[5][6])
{
	...
	else
	{
		...
		// [[transaction]]
		sprintf(tvin_coeffs, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_coeffs, tvin_coeffs);

		sc_bv<32>* coeffs_tvin_wrapc_buffer = new sc_bv<32>[30];
			...
			// bitslice(31, 0)
			{
				...
				// celement: coeffs(31, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 4; i_0 += 1)
					{
						...
						{
							// sub                   : i_0 i_1
							// ori_name              : coeffs[i_0][i_1]
							// sub_1st_elem          : 0 0
							// ori_name_1st_elem     : coeffs[0][0]
							// regulate_c_name       : coeffs
							// input_type_conversion : *(int*)&coeffs[i_0][i_1]
							if (&(coeffs[0][0]) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<32> coeffs_tmp_mem;
								coeffs_tmp_mem = *(int*)&coeffs[i_0][i_1];
								coeffs_tvin_wrapc_buffer[hls_map_index].range(31, 0) = coeffs_tmp_mem.range(31, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		for (int i = 0; i < 30; i++)
		{
			sprintf(tvin_coeffs, "%s\n", (coeffs_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_coeffs, tvin_coeffs);
		}

		tcl_file.set_num(30, &tcl_file.coeffs_depth);
		sprintf(tvin_coeffs, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_coeffs, tvin_coeffs);

		// release memory allocation
		delete [] coeffs_tvin_wrapc_buffer;

// [call_c_dut] ---------->

		CodeState = CALL_C_DUT;
		equalizer(y, x, mode, coeffs);
		...
		delete [] tvin_mode;
		// release memory allocation: "coeffs"
		delete [] tvin_coeffs;
