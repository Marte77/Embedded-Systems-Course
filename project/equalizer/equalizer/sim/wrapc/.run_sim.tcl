...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "equalizer.autotvin.dat"
	set constFileTvOut       "equalizer.autotvout.dat"
	set constFileHdlTvIn     "equalizer.autohdltvin.dat"
	set constFileHdlTvOut    "equalizer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
