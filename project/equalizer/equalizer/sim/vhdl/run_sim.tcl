...
if {[file isfile equalizer.autotvin.dat]} {
	file delete -force equalizer.autotvin.dat
}

if {[file isfile equalizer.autotvout.dat]} {
	file delete -force equalizer.autotvout.dat
}
