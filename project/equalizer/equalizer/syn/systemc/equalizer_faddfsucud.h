...
#ifndef __equalizer_faddfsucud__HH__
#define __equalizer_faddfsucud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(equalizer_faddfsucud) {
    ...
    SC_CTOR(equalizer_faddfsucud):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
