...
#include "equalizer_fdiv_32eOg.h"
...
struct equalizer : public sc_module {
    ...
    equalizer_fdiv_32eOg<1,16,32,32,32>* equalizer_fdiv_32eOg_U3;
    equalizer_fdiv_32eOg<1,16,32,32,32>* equalizer_fdiv_32eOg_U4;
    ...
    sc_signal< sc_lv<1> > tmp_1_reg_508;
    sc_signal< sc_lv<6> > tmp_10_fu_352_p2;
    sc_signal< sc_lv<6> > tmp_10_reg_512;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<3> > i_1_fu_364_p2;
    sc_signal< sc_lv<3> > i_1_reg_520;
    sc_signal< sc_lv<5> > iir_coeff_array_addr_2_reg_535;
    sc_signal< sc_lv<5> > iir_coeff_array_addr_3_reg_540;
    sc_signal< sc_lv<5> > iir_coeff_array_addr_4_reg_545;
    sc_signal< sc_lv<5> > iir_coeff_array_addr_5_reg_550;
    sc_signal< sc_lv<3> > i_fu_470_p2;
    sc_signal< sc_lv<3> > i_reg_558;
    sc_signal< sc_lv<3> > iir_x_1_addr_reg_563;
    sc_signal< sc_lv<1> > exitcond_i_fu_464_p2;
    sc_signal< sc_lv<3> > iir_x_0_addr_reg_568;
    sc_signal< sc_lv<3> > iir_y_1_addr_reg_573;
    sc_signal< sc_lv<3> > iir_y_2_addr_reg_578;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<5> > iir_coeff_array_addr_6_reg_588;
    sc_signal< sc_lv<3> > j_fu_497_p2;
    sc_signal< sc_lv<3> > j_reg_596;
    sc_signal< sc_lv<32> > iir_x_0_load_reg_601;
    sc_signal< sc_lv<32> > iir_x_1_load_reg_607;
    sc_signal< sc_lv<32> > grp_fu_271_p2;
    sc_signal< sc_lv<32> > tmp_i_reg_612;
    sc_signal< sc_lv<32> > grp_fu_276_p2;
    sc_signal< sc_lv<32> > tmp_4_i_reg_617;
    sc_signal< sc_lv<32> > tmp_7_i_reg_622;
    sc_signal< sc_logic > ap_CS_fsm_state10;
    sc_signal< sc_lv<32> > iir_y_1_load_reg_627;
    sc_signal< sc_lv<32> > iir_y_2_load_reg_632;
    sc_signal< sc_lv<32> > tmp_i_3_reg_637;
    sc_signal< sc_logic > ap_CS_fsm_state23;
    sc_signal< sc_lv<32> > tmp_10_i_reg_642;
    sc_signal< sc_lv<3> > i_i1_reg_222;
    sc_signal< sc_lv<1> > exitcond_i2_fu_491_p2;
    sc_signal< sc_lv<32> > temp_i_reg_233;
    sc_signal< sc_logic > ap_CS_fsm_state54;
    sc_signal< sc_lv<3> > i_i_reg_245;
    sc_signal< sc_lv<3> > j_i_reg_256;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<1> > exitcond1_i_fu_358_p2;
    sc_signal< sc_lv<32> > tmp_3_cast_fu_404_p1;
    sc_signal< sc_lv<32> > tmp_4_cast_fu_415_p1;
    sc_signal< sc_lv<32> > tmp_5_cast_fu_426_p1;
    sc_signal< sc_lv<32> > tmp_6_cast_fu_437_p1;
    sc_signal< sc_lv<32> > tmp_7_cast_fu_448_p1;
    sc_signal< sc_lv<32> > tmp_8_cast_fu_459_p1;
    sc_signal< sc_lv<32> > i_i_cast3_fu_370_p1;
    sc_signal< sc_lv<32> > tmp_12_cast_fu_485_p1;
    ...
    sc_signal< sc_lv<4> > tmp_s_fu_340_p3;
    sc_signal< sc_lv<6> > tmp_9_fu_332_p3;
    sc_signal< sc_lv<6> > p_shl3_cast_fu_348_p1;
    sc_signal< sc_lv<4> > tmp_2_fu_386_p3;
    sc_signal< sc_lv<6> > tmp_fu_378_p3;
    sc_signal< sc_lv<6> > p_shl1_cast_fu_394_p1;
    sc_signal< sc_lv<6> > tmp_3_fu_398_p2;
    sc_signal< sc_lv<6> > tmp_4_fu_409_p2;
    sc_signal< sc_lv<6> > tmp_5_fu_420_p2;
    sc_signal< sc_lv<6> > tmp_6_fu_431_p2;
    sc_signal< sc_lv<6> > tmp_7_fu_442_p2;
    sc_signal< sc_lv<6> > tmp_8_fu_453_p2;
    sc_signal< sc_lv<6> > j_i_cast1_cast_fu_476_p1;
    sc_signal< sc_lv<6> > tmp_11_fu_480_p2;
    sc_signal< sc_lv<2> > grp_fu_267_opcode;
    ...
    void thread_exitcond1_i_fu_358_p2();
    void thread_exitcond_i2_fu_491_p2();
    void thread_exitcond_i_fu_464_p2();
    void thread_grp_fu_267_opcode();
    ...
    void thread_i_i_cast3_fu_370_p1();
    ...
    void thread_j_fu_497_p2();
    void thread_j_i_cast1_cast_fu_476_p1();
    void thread_p_shl1_cast_fu_394_p1();
    void thread_p_shl3_cast_fu_348_p1();
    void thread_tmp_10_fu_352_p2();
    void thread_tmp_11_fu_480_p2();
    void thread_tmp_12_cast_fu_485_p1();
    void thread_tmp_1_fu_326_p2();
    void thread_tmp_2_fu_386_p3();
    void thread_tmp_3_cast_fu_404_p1();
    void thread_tmp_3_fu_398_p2();
    void thread_tmp_4_cast_fu_415_p1();
    void thread_tmp_4_fu_409_p2();
    void thread_tmp_5_cast_fu_426_p1();
    void thread_tmp_5_fu_420_p2();
    void thread_tmp_6_cast_fu_437_p1();
    void thread_tmp_6_fu_431_p2();
    void thread_tmp_7_cast_fu_448_p1();
    void thread_tmp_7_fu_442_p2();
    void thread_tmp_8_cast_fu_459_p1();
    void thread_tmp_8_fu_453_p2();
