...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../audioEqSolutionZ7.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../audioEqSolutionZ7.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../audioEqSolutionZ7.srcs/sources_1/bd/system/ipshared/2ad9/hdl" \
       +incdir+"../../../../audioEqSolutionZ7.srcs/sources_1/bd/system/ipshared/39ca/hdl/verilog" \
       +incdir+"../../../../audioEqSolutionZ7.srcs/sources_1/bd/system/ipshared/6eb1/hdl" \
       +incdir+"../../../../audioEqSolutionZ7.srcs/sources_1/bd/system/ipshared/1d61/hdl"
}
